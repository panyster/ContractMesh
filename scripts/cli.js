...
const contractABI = require("../artifacts/contracts/Contractmesh.sol/Contractmesh.json").abi;

program
    .name("contractmesh-cli")
    .description("CLI tool for Contractmesh smart contract")
    .version("1.0.0");
